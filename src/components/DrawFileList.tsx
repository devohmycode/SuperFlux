...
export interface DrawDoc {
  id: string;
  title: string;
  content: string; // JSON string of { elements, camera }
  folder?: string;
  createdAt: string;
  updatedAt: string;
}

const STORAGE_KEY = 'superflux_draw_docs';
const FOLDERS_KEY = 'superflux_draw_folders';

export function loadDrawDocs(): DrawDoc[] {
  try {
